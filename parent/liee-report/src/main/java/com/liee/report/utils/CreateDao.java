...
public class CreateDao {
	...
	public static void main(String[] args) throws Exception {
		new CreateDao().createDao4jdbc("com.liee.report.dao", "rep_report_column", System.getProperty("user.dir") + "\\src\\main\\java\\com\\liee\\report\\dao");
		// test();
	}
}
