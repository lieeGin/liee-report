...
<html>
  <head>
	...
	<script>
  	...
  	<script type="text/javascript" src="${path}/easyuiTemplate/system/syscode/sysCode.js"></script>
  </head>
  <body>
	  		...
	  		<div style="float:left;width:60%;height:90%;margin-top:5px;margin-left:5px">
		  		 <form id="editForm" >
	  					<table class="tableStyle">
	  						<tr>
	  							<td align="right" class="tdStyle">字典编号:
	  								<input type="hidden" name="id" id="id">
	  								<input type="hidden" name="sort" id="sort">
	  								<input type="hidden" name="parentCode" id="parentCode">
	  							</td>
	  							<td align="left" class="tdStyle">
	  								<input type="text" name="code" id="code" class="easyui-validatebox"  style="font-size:12px;width:300px;" required="true"/>
	  							</td>
	  						</tr>
	  						<tr>
	  							<td align="right" class="tdStyle">字典文本:</td>
	  							<td align="left" class="tdStyle">
	  								<input type="text" name="text" id="text" class="easyui-validatebox"  style="font-size:12px;width:300px;" />
	  							</td>
	  						</tr>
	  						<tr>
	  							<td align="right" class="tdStyle">备注:</td>
	  							<td align="left" class="tdStyle">
	  								<input type="text" name="remark" id="remark" class="easyui-validatebox"  style="font-size:12px;width:300px;" />
	  							</td>
	  						</tr>
	  						<tr>
